...
"puppet_enterprise::profile::master::r10k_remote": "https://github.com/ipcrm/control-repo-1.git"
...
puppetlabs
TEXT
/opt/puppetlabs/bin/puppet-code deploy -w --all
